...
export function createWebServer() {
  ...
  // Every user (including the operator) only sees their own data.
  ...
  // Every user (including the operator) only sees their own wallets.
  ...
  // ───── Positions ─────
  // Every user (including the operator) only sees their own positions.
